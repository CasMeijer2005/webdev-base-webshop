...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 26 mrt 2022 om 19:58
...
INSERT INTO `admin_user` (`admin_user_id`, `email`, `admin_user_name`, `password`, `password_token`, `password_changed`, `datetime`) VALUES
(1, 'test@test.nl', 'test', '$2y$10$pYXtUFm08TcdO9VFwtaxxeSZ0fZJa6FcINYrHhpd3JdqHtojZ7uh6', '', '2022-03-14 20:11:18', '2022-02-25 13:06:17'),
(2, 'robbertcasmeijer@gmail.com', '', '1234', NULL, NULL, '2022-03-26 18:40:52'),
(6, 'robbertcsmeijer@gmail.com', '', ' test', NULL, NULL, '2022-03-26 18:50:13'),
(7, 'robertcasmeijer@gmail.comt', '', '1234', NULL, NULL, '2022-03-26 18:51:35'),
(8, 'rtcasmeijer@gmail.com', '', ' test', NULL, NULL, '2022-03-26 18:53:47');
...
--
ALTER TABLE `admin_user`
  MODIFY `admin_user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
